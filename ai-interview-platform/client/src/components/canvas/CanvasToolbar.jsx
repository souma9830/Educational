import { Layout, Database, Cpu, Server, Globe, Download, Trash2, Plus } from 'lucide-react';

const CanvasToolbar = ({ onAddNode, onClear }) => {
  const nodeTypes = [
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 bg-slate-950 p-4 rounded-2xl border border-slate-800">
      <div className="flex items-center gap-2 flex-wrap">
        <span className="text-xs font-bold text-slate-400 mr-2">Architecture Nodes:</span>
        {nodeTypes.map((item) => {
